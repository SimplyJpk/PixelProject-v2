...
template class TimeTracker<TimeFormat::Nano>;
template class TimeTracker<TimeFormat::Micro>;
template class TimeTracker<TimeFormat::Milli>;
template class TimeTracker<TimeFormat::Second>;
template class TimeTracker<TimeFormat::Minute>;
template class TimeTracker<TimeFormat::Hour>;