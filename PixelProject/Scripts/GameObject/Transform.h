...
public:
   ...
   // Getters and Setters
   const glm::vec3& GetPosition() const INLINE_RETURN(_position)
   void SetPosition(const glm::vec3& position);

   const glm::vec3& GetRotation() const INLINE_RETURN(_rotation)
   void SetRotation(const glm::vec3& rotation);

   const glm::vec3& GetScale() const INLINE_RETURN(_scale)
