...
public:
   ...
   size_t GetHash() const INLINE_RETURN(_hash)
   ...
   KeyCode GetKeyAsKeyCode() INLINE_RETURN(static_cast<KeyCode>(key))
   MouseCode GetAsMouseCode() INLINE_RETURN(static_cast<MouseCode>(key))
