...
public:
   FirePixel()
   {
      ...
      SET_PIXEL_UPDATE_ORDER(0, WorldDir::North, WorldDir::NorthEast, WorldDir::NorthWest, WorldDir::SouthWest, WorldDir::SouthEast);
      SET_PIXEL_UPDATE_ORDER(1, WorldDir::North, WorldDir::NorthWest, WorldDir::NorthEast, WorldDir::SouthEast, WorldDir::SouthWest);
