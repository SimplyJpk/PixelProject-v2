...
namespace PixelMask {
   struct Index {
      ...
      constexpr static Uint32 GetMask() { return BITS << DEPTH; }
      constexpr static Uint32 GetMaxValue() { return (1 << COUNT) - 1; }
   ...
   struct Lifetime {
      ...
      constexpr static Uint32 GetMask() { return BITS << DEPTH; }
      constexpr static Uint32 GetMaxValue() { return (1 << COUNT) - 1; }
      constexpr static uint8_t GetValue(const Uint32 value) { return (value & GetMask()) >> DEPTH; }
   };
